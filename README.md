...
回復薬を作るだけでもかなり大変なクエストだと感じたハンターは、どうにかして楽をできないかを考えました。そこで、ネコを雇うことに。
...
<br>
プロミスには今回、薬草とアオキノコを採取してきてもらう仕事を任せました。<br>
...
プロミスからアオキノコを受け取ったハンターはすぐに回復薬を作り依頼者に納品します。こうしてハンターはうまく時間を使えるようになりました。
