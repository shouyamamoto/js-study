...
<br>
まず「薬草」を採取、次に「アオキノコ」を採取、そして 2 つを調合して「回復薬」を作り、無事クエスト依頼者に納品することができました。<br>
今回、薬草はすぐに見つかったものの、アオキノコがなかなか見つからずクエスト完了に 40 分かかってしまいました。ハンターはどうにかしてクエスト達成するための時間を短くできないかと考え、仲間を雇うことに。<br>
...
<br>
プロミスには今回、アオキノコを採取してきてもらう仕事を任せました。ハンターはアオキノコを探す手間がなくなったので、その時間で回復薬を調合する準備をすることができます。<br>
そしてプロミスはアオキノコを見つけ次第ハンターに渡します。プロミスからアオキノコを受け取ったハンターはすぐに回復薬を作ることができ、クエスト達成時間を短縮することができました！！
